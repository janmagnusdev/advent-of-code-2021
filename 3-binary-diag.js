...
var oxygenCriteria = function (input, bits, bitPosition) {
    ...
    var mostCommon = zeros < ones ? "0" : "1";
    return input.filter(function (input) { return input.charAt(bitPosition) !== mostCommon; });
};
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var res, input, oxygenRating, carbonDyoxideRating, e_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
            ...
            case 1:
                ...
                oxygenRating = parseInt(findRating(oxygenCriteria, input), 2);
                carbonDyoxideRating = parseInt(findRating(carbonDyoxideCriteria, input), 2);
                console.log("Life Support Rating is: ".concat(oxygenRating * carbonDyoxideRating));
                return [3 /*break*/, 3];
            case 2:
                e_2 = _a.sent();
                console.error(e_2);
